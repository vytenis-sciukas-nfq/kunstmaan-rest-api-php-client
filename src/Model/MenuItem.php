...
class MenuItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'menu' => '\NFQ\KunstmaanRestApi\PhpClient\Model\Folder',
        'nodeTranslation' => '\NFQ\KunstmaanRestApi\PhpClient\Model\NodeTranslation',
        'type' => 'string',
        'title' => 'string',
        'url' => 'string',
        'newWindow' => 'bool',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('newWindow', $data ?? [], null);
    ...
    */
     ...
     * Sets menu
     *
     * @param \NFQ\KunstmaanRestApi\PhpClient\Model\Folder|null $menu menu
     *
     * @return self
     */
     ...
     *
     * @return \NFQ\KunstmaanRestApi\PhpClient\Model\NodeTranslation|null
     */
     ...
     *
     * @param \NFQ\KunstmaanRestApi\PhpClient\Model\NodeTranslation|null $nodeTranslation nodeTranslation
     *
     * @return self
     */
    ...
    {
        return $this->container['newWindow'];
    }

    /**
     * Sets newWindow
     *
     * @param bool|null $newWindow newWindow
     *
     * @return self
     */
    public function setNewWindow($newWindow)
    {
        if (is_null($newWindow)) {
            throw new \InvalidArgumentException('non-nullable newWindow cannot be null');
        }
        $this->container['newWindow'] = $newWindow;
